...
(function () {
	const root = document.getElementById('starscape');
	Starscape.make(root, { color: '#FFDC0044', max_diameter: 1, density: 2000 });
	Starscape.make(root, { color: '#7FDBFF88', max_diameter: 3, min_diameter: 2, density: 100 });
})();
